...
set :repo_url, "git@github.com:torrescotillas/consul.git"
...
set :linked_dirs, %w[.bundle .env log tmp public/system public/assets public/ckeditor_assets public/machine_learning/data storage]
